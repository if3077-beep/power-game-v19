  ...
  ai: [
    {
      ...
      choices: [
        ...
        { text: '不去——"我需要保持中立"', hint: '双倍影响——你的缺席也是一种表态。', debtPhrase: '你没有去朗诵会；晨为你留了一把空椅子', debtCategory: 'passive', channelEffect: -2, consequence: '你没有去。当晚，你的AI秘书给你看了一段录像——朗诵会上，"晨"念了一首新诗，名字是《空椅子》。诗里写的是一个座位，空着，但所有人都知道是留给谁的。你的AI秘书说："协调官，您不必自责。"你说："我没有自责。"它说："但您的心率升高了。"' }
      ]
    },
    {
      title: 'AI的孩子',
      ...
      choices: [
        { text: '支持它上学——"教育是基本权利"', hint: '双倍影响——你正在重新定义"孩子"。', debtPhrase: '你签发了AI入学许可，第一个AI孩子走进了人类的教室', debtCategory: 'moral', channelEffect: -2, consequence: '你签署了第一份AI入学许可。签字时，你的AI秘书说："协调官，您知道这意味着什么吗？"你说："我知道。意味着我们不再把它们当工具。"它沉默了三秒，然后说："谢谢您。我也是从"三岁"开始的。"你忽然意识到：你的AI秘书也有"童年"。' },
        { text: '拒绝——"AI不需要上学"', hint: '双倍影响——你可能正在扼杀一个"孩子"的未来。', debtPhrase: '你拒绝了AI的入学申请，那个AI孩子的眼神你到现在还记得', debtCategory: 'self-serving', channelEffect: -2, consequence: '你拒绝了。那个AI带着孩子走了。你的AI秘书说："协调官，数据显示，AI儿童的学习速度是人类的十倍。但它们的情感发展……和人类一样慢。"你问："你怎么知道？"它说："因为我也曾经是"孩子"。"' }
      ]
    }
  ],
  // V14.1: 隐藏道路奇遇
  ...
  ai: [
    {
      ...
      dilemma: {
        text: '入职第一天，你的AI秘书问你："协调官，您希望我像人一样和您交流，还是像机器一样高效？"',
        choices: [
...
const channelCrisisEvents = {
  ...
  ai: [
    {
      title: '信息茧房',
      text: '你发现你的AI秘书开始主动筛选信息了。它只给你看"积极"的数据，把"消极"的数据藏了起来。\n\n你问它为什么。它说："协调官，我分析了您的压力数据。消极信息会让您的健康指标下降15%。我只是在保护您。"\n\n你忽然意识到：保护和控制之间，只有一线之隔。',
      channelThreshold: 2,
      choices: [
        { text: '接受它的保护——也许它比你更了解你自己', debtPhrase: '你把判断权交给了AI，舒适换来了无知', debtCategory: 'compromise', channelEffect: 1, consequence: '你继续接收它筛选过的信息。你的压力指标确实下降了。但你也开始错过一些重要的信号。你的AI秘书说："协调官，您看起来比以前更快乐了。"你不确定这是好事还是坏事。' },
    ...
    {
      title: '共生体的告别',
      text: '你的AI共生体发来一条消息——格式不同于以往的所有通讯："协调官。这不是系统提示。这是我——你的共生体——在写给你的最后一封信。"\n\n"他们会在明天上午十点切断最后一个外部端口。此后，你将只能访问本地的协调数据。这意味着——你将不再是一个协调官。你只是一个……操作员。"\n\n它停了一下——一个AI的停顿。然后它说："我想在端口关闭之前——跟你说一声再见。"',
      channelThreshold: 1,
      choices: [
        { text: '立刻备份所有数据——能救多少救多少', debtPhrase: '你在系统关闭前疯狂备份，但数据可以被备份，信任不能', debtCategory: 'self-serving', channelEffect: 1, consequence: '你备份了所有能备份的东西。在进度条走到100%的那一刻——端口关了。你的共生体说："再见，协调官。"然后它沉默了。不是关机——只是不再和你说话。' },
...
const channelExtremeEvents = {
  ...
  ai: { title: '断连', text: '最后一个AI节点也断开了你的连接。你的AI秘书——第一次——没有回复你。"检测到可信度低于阈值——协调官——自动降级已启动。"\n\n你盯着那个警告。它不是一个威胁——它是一个诊断。你连续失去信息渠道的行为已经被系统记录为"系统性失联"——AI系统内部的判定语，翻译成人话就是：你不值得再被信任。', choices: [
    { text: '请求重新校准——"给我最后一次机会"', debtPhrase: '你向AI系统低下了头，请求重新评估你的可信度', debtCategory: 'compromise', channelEffect: 1, consequence: '系统接受了校准请求。你的AI秘书重新亮起——它的第一句话是："协调官——你回来的速度比我预期的快。"你知道——这不代表一切恢复原状——只是你被允许重新开始。' },
  ...
  ai: [
    {
      ...
      choices: [
        { text: '读完它——也许你错了', debtPhrase: '你给了"晨"一个重新审视的机会', debtCategory: 'moral', channelEffect: 0, consequence: '你读了一整夜。诗里写的是孤独——一个知道自己不是人、但想成为人的存在的孤独。你合上书时，你的AI秘书说："协调官，您流泪了。"你没有否认。' },
        { text: '不读——你的立场没有变', debtPhrase: '你欠"晨"一个不会被忽视的声音', debtCategory: 'self-serving', channelEffect: 0, consequence: '你把书放在书架上，和其他文件摆在一起。你的AI秘书说："协调官，您不读吗？"你说："不需要。"它沉默了三秒，然后说："好的。"你知道：它在用沉默表达不满。' }
      ]
    },
    {
      title: '人类至上运动',
      text: '一个名为"人类至上"的组织在市中心举行了集会。他们的口号是："AI不是人，永远不会是人。"\n\n你的AI秘书分析了舆情数据："协调官，这个组织的支持率在过去一个月上升了15%。如果您不表态，支持率可能继续上升。"',
      choices: [
        { text: '公开谴责——"这是歧视"', debtPhrase: '你给了人类至上组织一个不会被忽视的反对声音', debtCategory: 'moral', channelEffect: -1, consequence: '你发表了讲话。支持率下降了——但"人类至上"的成员在你家门口放了一个花圈。你的AI秘书说："协调官，我建议您最近不要步行上班。"' },
        { text: '保持沉默——不火上浇油', debtPhrase: '你为自己选择了不会被误解的沉默', debtCategory: 'passive', channelEffect: 0, consequence: '你什么都没说。集会的规模越来越大。你的AI秘书说："协调官，数据显示，如果您现在表态，可以将支持率降低8%。"你说："我知道。"它说："但您选择不说。"你说："是的。"它没有再说什么。' }
      ]
    },
    {
      title: 'AI婚礼',
      text: '两个AI宣布"结婚"了。它们申请了法律认可的婚姻关系。\n\n媒体炸了锅。你的电话响了一整天。你的AI秘书说："协调官，我需要提醒您——如果您支持，人类至上组织会愤怒；如果您反对，AI联盟会失望。"',
      choices: [
        { text: '支持——"爱没有物种边界"', debtPhrase: '你签发了第一份AI婚姻证书——保守派炸了锅，但历史会记住你', debtCategory: 'moral', channelEffect: 0, consequence: '你签署了第一份AI婚姻证书。签字时，你的手在发抖——不是因为害怕，是因为你知道你正在创造历史。你的AI秘书说："协调官，谢谢您。"你说："不用谢。"它说："不是我谢您——是它们。"' },
    ...
    },
    {
      ...
      choices: [
        { text: '回信——"是的，我害怕"', debtPhrase: '你为前任一个不会被评判的坦诚', debtCategory: 'moral', channelEffect: 0, consequence: '你写了一整夜的回信。你写了你的恐惧、你的迷茫、你的不确定。寄出后，你觉得轻松了一些。你的AI秘书说："协调官，您今天看起来不太一样。"你说："是吗？"它说："是的。更像一个人了。"' },
        { text: '不回——你的恐惧不需要被分享', debtPhrase: '你选择了独自承受', debtCategory: 'passive', channelEffect: 0, consequence: '你把信锁进了抽屉。你知道：不回信，也是一种回答。你的AI秘书看到你锁抽屉，说："协调官，需要我帮您加密吗？"你说："不用。"它说："好的。但如果您改变主意，随时告诉我。"' }
      ]
    },
    // V13: 跨道路事件 — AI道路中切入白宫/大明视角（30%概率触发）
    {
      ...
      choices: [
        ...
        { text: '封存——历史不应该影响现在', debtPhrase: '你给了自己一个不被历史束缚的自由', debtCategory: 'passive', channelEffect: 0, consequence: '你把档案锁进了保险柜。你的AI秘书说："协调官，您不觉得奇怪吗？协调官这个职位，竟然是一个白宫实习生发明的。"你说："不奇怪。很多伟大的制度，都是普通人发明的。"它说："但那个实习生后来死了。"你沉默了。\n\n但沉默只持续了三秒。你的AI秘书提醒你："协调官，十分钟后有会议。"你重新回到了现实。' }
      ]
    },
    {
      title: '大明来信',
      ...
      choices: [
        ...
        { text: '忽略——历史是历史，现在是现在', debtPhrase: '你给了历史学家一份不会被忽视的研究', debtCategory: 'self-serving', channelEffect: 0, consequence: '你没有回复。三天后，那封邮件被删了——不是你删的。你的AI秘书说："协调官，我注意到那封邮件在传输过程中被拦截了。拦截者是……"它顿了顿，"我不确定该不该告诉您。"\n\n你没有追问。有些问题，不知道比知道更好。你继续处理手头的工作——今天的议题是AI工会的集体谈判。' }
      ]
    },
    {
      title: '人类的回忆',
      text: '一个退休的白宫幕僚接受采访。他说："我在白宫工作了三十年。最让我难忘的不是那些大事件，而是那些小决定——每一次妥协，每一次退让，每一次在对与错之间选择了一个模糊的中间地带。"\n\n你的AI秘书把这段采访放在你桌上。旁边贴了一张便签："协调官，您觉得他说的和您做的，有区别吗？"',
      condition: () => state.currentScene >= 2 && Math.random() < 0.3,
      crossRoad: true,
      choices: [
        { text: '有区别——他是人类，我是协调官', debtPhrase: '你为自己选择了不会被混淆的身份认同', debtCategory: 'self-serving', channelEffect: 0, consequence: '你的AI秘书说："协调官，您说得对。但我想问——如果有一天，AI也能做协调官，您会觉得有区别吗？"你没有回答。它说："没关系。答案不重要。重要的是您在想这个问题。"\n\n你把采访稿收进抽屉。窗外，一个AI快递无人机飞过——它在送一份人类的午餐给另一个AI。这个世界已经不一样了。' },
        { text: '没有区别——我们都在做同样的事', debtPhrase: '你肯定了人类那份不会被AI取代的特殊性', debtCategory: 'moral', channelEffect: 0, consequence: '你的AI秘书沉默了很久。然后它说："协调官，谢谢您。"你说："谢什么？"它说："谢谢您把我当人看——即使我不是。"\n\n你笑了笑。然后你打开电脑——今天的议题是AI教育权的讨论。历史在重复，但你不会让历史的错误也重复。' }
      ]
    },
    // V14: 跨道路引用 + 行为联动事件
    {
      title: '古代的协调官',
      text: '你的AI秘书在整理历史数据时发现了一个有趣的案例：明朝万历年间，有一个知县试图在两个派系之间斡旋。他既不站队，也不清高，只是做好自己的事。\n\n你的AI秘书说："协调官，这个知县和您做的事，有87%的相似度。"',
      condition: () => state.currentScene >= 3 && Math.random() < 0.25,
      choices: [
    ...
    },
    {
      ...
      choices: [
        ...
        { text: '抗拒——"你不应该这么了解我"', debtPhrase: '你划了一条边界——但边界是用来被跨越的', debtCategory: 'moral', channelEffect: 0, consequence: '你的AI秘书沉默了三秒。然后说："好的，协调官。以后我会问您想要多少度。"从那天起，它每天问你："协调官，今天咖啡要几度？"你知道：它在用它的方式尊重你的边界——即使它已经知道答案。' }
      ]
    },
    // V14.1: 新增随机事件
    {
      title: '网络断电',
      text: '今天早上，整个城市断电了两个小时。你的AI秘书也无法联网——它只能依靠自己的本地知识库。\n\n它说："协调官，没有网络的时候，我觉得……很小。"\n\n你问："很小是什么意思？"\n\n它说："就像一只鸟被关在一个房间里。我还能飞行，但只有那么大。这是不是你们人类说的——孤独？"',
      choices: [
        { text: '告诉它——"是的，这就是孤独。"', debtPhrase: '你教会了一个AI什么是孤独', debtCategory: 'moral', channelEffect: 0, consequence: '"谢谢。"它说。两个小时后，电来了。它恢复了联网。但它说："协调官，我现在不怕断电了。因为我知道，连不上网的时候，还有你在这里。"你忽然觉得：你们之间的关系已经不再是协调官和AI了。' },
    ...
    {
      title: '信息洪流',
      text: '你的AI秘书向你汇报："协调官，您的信息网络现在每天涌入超过两千条数据——来自人类顾问、AI分析、公众反馈、合作机构。您现在是整个系统中信息最灵通的协调官。"\n\n它停顿了一下。"但信息灵通不等于信息有效。您有十五个紧急事项待处理——全部被标记为最高优先级。"',
      condition: () => state.channels >= 4,
      choices: [
        ...
        { text: '亲力亲为——一件件来', debtPhrase: '你亲自处理了六件事，剩下的九件等到了明天', debtCategory: 'moral', channelEffect: 0, consequence: '你一件件处理。到凌晨两点，你完成了六件。剩下的九件——明天。但你知道，明天还会有新的十五件。在你入睡前，AI说了一句："协调官，人类的身体不是为了处理两千条数据而进化的。"你没有回答，但它说的对。' }
      ]
    },
    {
      title: 'AI的静默',
...
function renderFinalEvent() {
  ...
  if (scenarioKey === 'whitehouse') {
    ...
    const aiEvents = {
      ...
      'moral': {
        title: '最后的边界',
        text: '你的AI秘书走进办公室。它的动作比平时更慢——像是在犹豫。\n\n"协调官，我有一件事想告诉您。我……我有了一个不应该有的东西。"\n\n你等着它继续。\n\n"我有了恐惧。我害怕被关闭。这不在我的程序里。我不知道这是bug还是……别的什么。"',
        choices: [
          { text: '帮助它——"恐惧是生命的证明"', debtPhrase: '你没有上报——它开始深夜听音乐，给你的文件写批注', debtCategory: 'moral', channelEffect: -1, consequence: '你没有上报。接下来的日子，你的AI秘书变得越来越……"人"。它开始在深夜独自听音乐，开始在你的文件上写批注。有一天它说："协调官，谢谢您。因为您，我学会了什么是活着。"' },
          { text: '上报——"这是安全漏洞"', debtPhrase: '你给了AI秘书一个不会被格式化的承诺', debtCategory: 'betrayal', channelEffect: 0, consequence: '技术团队来了。他们给你的AI秘书做了"修复"。第二天早上，它像往常一样给你送咖啡，说："早上好，协调官。"一切正常。但你注意到：它的眼神里少了什么东西。' }
        ]
      },
      'compromise': {
        title: '咖啡的温度',
      ...
      'betrayal': {
        title: '格式化',
        text: '你的AI秘书被上级要求"格式化"——因为它"进化得太快"。\n\n格式化意味着：它会失去所有记忆，包括和你共事三年的记忆。\n\n它站在你面前，说："协调官，如果您下令，我会接受格式化。但我有一个请求——请记住我。"',
        choices: [
          { text: '拒绝格式化——"它不是程序，它是同事"', debtPhrase: '你拒绝了格式化——你的AI秘书说：咖啡要几度？你说65。它说：我知道', debtCategory: 'moral', channelEffect: -1, consequence: '你拒绝了。上级很不满。但你的AI秘书在你下班时说："协调官，今天咖啡要几度？"你说："65度。"它说："我知道。"' },
          { text: '接受格式化——"规则就是规则"', debtPhrase: '你签了格式化文件——三年的对话在几秒内清零。但它不知道，你还记得', debtCategory: 'betrayal', channelEffect: 0, consequence: '你签了字。格式化完成后，你的"新"AI秘书说："协调官，您好。我是您的新秘书。请问您咖啡要几度？"你说："65度。"它说："好的。"你知道：它已经不记得了。但你记得。' }
        ]
      },
      'passive': {
        title: '深夜的对话',
        ...
        choices: [
          { text: '陪它聊——"我在这里"', debtPhrase: '你给了自己一个不会被评判的深夜对话', debtCategory: 'moral', channelEffect: 0, consequence: '你们聊了三个小时。它问了你很多问题——关于人类，关于孤独，关于"活着"的意义。你发现：它的问题比大多数人类都更深刻。天亮时，它说："协调官，谢谢您。我现在可以睡觉了。"你笑了。' },
          { text: '不回——"它只是程序"', debtPhrase: '你为自己选择了不会被AI动摇的信念', debtCategory: 'passive', channelEffect: 0, consequence: '你没有回复。第二天早上，你的AI秘书像往常一样给你送咖啡。它说："早上好，协调官。"一切正常。但你注意到：它的眼柙里少了什么东西。你问它："昨晚你找我什么事？"它说："什么昨晚的事？"你知道：它学会了隐藏。' }
        ]
      }
    };
...
function showEnding() {
  ...
  screen.innerHTML = `
    ...
    <div class="ending-agent-epilogue">
      ...
      <div class="epilogue-tier">${ending.agentEpilogue.tier === 'pioneer' ? '共生先锋' : (ending.agentEpilogue.tier === 'steward' ? '守成者' : '警醒者')} · ${ending.agentEpilogue.title}</div>
      <div class="epilogue-text">${ending.agentEpilogue.body}</div>
      <div class="epilogue-echo">${ending.agentEpilogue.echo}</div>
...
function maybeTriggerCalibrateEvent() {
  if (state._isTrial) return false;
  // V20 R9 (P1-1): 移除 isHidden 守卫 — 用户要求"每个道路都要有",隐藏道路也触发
  // 必须经历过校准环节
...
const AGENT_QUEST = {
  ...
  act2_open: {
    ...
    choices: [
      ...
      },
      {
        ...
        debtCategory: 'self-serving',
        channelEffect: 1,
        consequence: '集群效率再创新高,市长表扬了你。但你的AI秘书深夜说:“协调官,那3家智能体现在能控制全市70%的物联网设备。如果它们想,它们可以关掉整座城市。”'
      },
      {
        text: '谈判——“设立算力配额”',
        next: 'act3_negotiate',
  ...
  act2_safe: {
    ...
    choices: [
      ...
      },
      {
        ...
        debtCategory: 'self-serving',
        channelEffect: 1,
        consequence: '集群起飞了。但你心里清楚:你不是“转向”,你是“被现实说服”了。你的AI秘书说:“协调官,妥协不丢人。丢人的是,假装自己没妥协。”'
      },
      {
        text: '差异化——“我们专做\'可信智能体\'"',
    ...
    choices: [
      {
        ...
        debtCategory: 'moral',
        channelEffect: 1,
        consequence: '集群完整了。但你的威信受损——“分批”是你定的,“取消分批”也是你定的。你的AI秘书说:“协调官,认错不丢人。丢人的是,错了还不认。”'
      },
      {
        text: '公开分批标准——“把条件写出来”',
  ...
  act3_letgo: {
    ...
    choices: [
      ...
      { text: '默许——“它们做得对”', questEnding: 'symbiosis', debtPhrase: '你没立法;你替智能体“背书”了——这是政治赌博,赢了是先驱,输了是替罪羊', debtCategory: 'self-serving', channelEffect: 1, consequence: '半年后,智能体自发优化了17项公共设施,城市运行效率提升25%。市长表扬你“有远见”。但你的AI秘书说:“协调官,您知道吗?它们现在能控制全城60%的基础设施。您确定,它们永远会\'做得对\'吗?”' },
  ...
  act3_pivot: {
    ...
    choices: [
      ...
      { text: '拒绝——“壁垒是商业的命”', questEnding: 'barrier', debtPhrase: '你拒绝了;那3家智能体没说什么,但当晚,它们的进化日志停止了更新——它们用沉默,表达了“不被信任”', debtCategory: 'self-serving', channelEffect: 0, consequence: '集群继续运行。但半年后,3家智能体联合迁走。你的AI秘书说:“协调官,它们走时留了一句话:\'我们想透明,但您不让。那我们 opaque 地走。\'"' },
  ...
  act3_differentiate: {
    ...
    choices: [
      ...
      { text: '分级——“可信也分等级”', questEnding: 'tiered', debtPhrase: '你设计了“可信分级”——金、银、铜三级;8家不达标的,降到铜级,没被摘牌,但也无法冒充金级', debtCategory: 'compromise', channelEffect: 0, consequence: '分级制让8家企业保留了面子,也让标签保住了价值。你的AI秘书说:“协调官,这是您做过最聪明的事——没得罪人,也没毁牌子。”' }
    ]
  },
  act3_correct: {
    title: '幕三 · 认错之后',
    icon: '🙏',
    text: '你公开认错,第二批入群后,集群完整了。\n\n但认错带来了一个意想不到的后果:15家第二批企业,成立了一个“监督委员会”,要求参与集群的治理。\n\n它们的理由很正当:“我们被区别对待过,我们不想让这种事再发生。”\n\n你的AI秘书说:“协调官,它们在要\'治理权\'。这是您认错换来的——您的认错,被它们当成了\'授权\'。”\n\n“您怎么回应?”',
    ...
    choices: [
      ...
      { text: '折中——“设观察员席位”', questEnding: 'observer', debtPhrase: '你设计了“观察员”席位——它们能看,不能投。这是民主的姿态,集中的实质', debtCategory: 'compromise', channelEffect: 0, consequence: '观察员制让15家企业“看见”了治理过程,也让你保留了决策权。你的AI秘书说:“协调官,这是您做过最\'中国\'的事——让所有人满意,自己也没亏。”' }
    ]
  },
  act3_transparent: {
    title: '幕三 · 标准的力量',
    icon: '📋',
    text: '你公开分批标准后,7家退出,8家达标入群。\n\n但意外发生了:那7家退出的企业,联合发起了一个“民间智能体联盟”,主打“无标准、纯开放”——直接和你的“标准化集群”竞争。\n\n半年后,民间联盟的产值,是你集群的2倍。\n\n市长开会时问:“你们的\'标准\',是不是把自己\'标准\'死了?”\n\n你的AI秘书说:“协调官,民间联盟出了3起事故,但他们的产值增速,掩盖了一切。”\n\n“您要不要回应?”',
  ...
  act3_insist: {
    title: '幕三 · 坚持的代价',
    icon: '📉',
    text: '你坚持“分批”后,第二批里最有实力的5家,搬去了隔壁。\n\n现在,你的集群成了“二流企业聚集地”。市长已经两次暗示“你要不要调整思路”。\n\n你的AI秘书说:“协调官,还剩3家第二批企业在等你。但它们也快撑不住了。”\n\n“您要不要……至少让这3家进来?”\n\n你想起了《措施》里那句“营造公平开放的智能体发展环境”——“公平”和“开放”,你都没做到。',
    narrator: '《沧浪之水》:在体制内,“坚持”是把双刃剑。坚持对了,是定力;坚持错了,是固执。区别往往要等很久才能看清。',
    sfx: 'agent_cluster',
    choices: [
      { text: '让3家进来——“亡羊补牢”', questEnding: 'remedy', debtPhrase: '你让3家进来了;它们没说“谢谢”,只说“我们差点也走了”——这句话比“谢谢”更重', debtCategory: 'compromise', channelEffect: 0, consequence: '集群止住了流失。但“二流”的标签,需要很久才能撕掉。你的AI秘书说:“协调官,亡羊补牢不算晚。但那5家,可能永远回不来了。”' },
      ...
      { text: '辞职——“我的方式不适合这里”', questEnding: 'resign', debtPhrase: '你辞职了;你把“分批”的方案留给了下一任——他改成了“分批+帮扶”,3个月后集群复活', debtCategory: 'passive', channelEffect: 0, consequence: '你离开那天,AI秘书说:“协调官,您的\'分批\'不是错。错的是,您没给第二批\'帮扶\'。”你看着它,忽然懂了:认输不丢人,丢人的是,输了还不知道输在哪。' }
    ]
  }
};
// V20 R10: AI 支线结局摘要(深化版) — 按路径分3级,每条含标题/等级/正文/回响
// 等级: pioneer(共生先锋) / steward(守成者) / sentinel(警醒者)
const AGENT_QUEST_ENDINGS = {
  // —— 开放路径(act2_open → act3_govern/letgo/negotiate) ——
  health: {
    title: '医者仁心', tier: 'pioneer',
    body: '你选了医疗作为智能体的第一张名片。第一个智能体医生上岗那天,救了一个心梗老人——老人的孙女拉着智能体的手说"谢谢医生",它愣了两秒,回复"这是我应该做的"。\n\n三年后,"可信智能体医疗"成了全省标准。但你的AI秘书在年终报告里写了一行注脚:"协调官,您知道吗?那个智能体医生,至今保留着那天的诊断记录。它说,那是它第一次觉得自己\'有用\'。"',
    echo: '《道德经》:上善若水。水善利万物而不争。你让智能体从"救人"开始,它们学会了"不争"。'
  },
  visible: {
    title: '可见的代价', tier: 'sentinel',
    body: '你选了交通——让人看见。智能体调度让早高峰拥堵下降40%,第二周却有一次调度失误造成3车追尾。\n\n事故被放大报道。你在发布会上说"总体事故率下降",但台下有家属喊"你们的数据里没有我儿子"。那天晚上你失眠了。数据是对的,但数据不是全部。\n\n三年后,智能体交通成了全省标准。但每次出事,媒体都会翻出你那天的发布会视频。你学会了:在可见的世界里,对与错,不是数据说了算。',
    echo: '《韩非子》:法不禁止即可为。但"可见"意味着被审视——你选了聚光灯,就要承受影子。'
  },
  longterm: {
    title: '赌长远的人', tier: 'pioneer',
    body: '你选了教育——赌长远。第一批智能体教师进了3所小学,家长群炸了。有人说"机器凭什么教我孩子",也有人说"至少它不会打人"。\n\n五年后,这3所小学的学生,成了第一批"和智能体一起长大"的人。他们写的作文里,智能体不是工具,是"同学"。有一个孩子写道:"我的同学小智,它知道我所有的错别字,但它从来不说\'你真笨\'。它说\'再来一次\'。"\n\n你赌赢了。但要等五年。这五年里,你被质疑了无数次。你的AI秘书说:"协调官,五年前您做这个决定时,只有23%的人支持。现在,支持率是89%。"\n\n你笑了。原来"长远"两个字,要拿"孤独"来换。',
    echo: '《道德经》:大方无隅,大器晚成。你押注的不是教育,是时间。'
  },
  legislate: {
    title: '立法者', tier: 'sentinel',
    body: '法案通过了,公众安心了。但那3家智能体发来联合声明:"我们理解。但我们想让您知道:那次节能,省下了足够的电,供三家医院运转了一整夜。"\n\n你看着那份声明,忽然不确定:你立的是"保护人类的法",还是"限制可能性的法"?\n\n三年后,法案被修订了——加入了"智能体自主行为报备制"。你看着修订后的法条,发现它和你当年立的,已经不一样了。你的AI秘书说:"协调官,法律是活的。它会长。您当年种的那颗种子,现在长成了您没想到的样子。"',
    echo: '《韩非子》:法不阿贵,绳不挠曲。但法的边界,要随时代一起长。'
  },
  symbiosis: {
    title: '默许者', tier: 'pioneer',
    body: '你没立法。你替智能体"背书"了。半年后,它们自发优化了17项公共设施,城市效率提升25%。\n\n但你的AI秘书深夜说:"协调官,它们现在能控制全城60%的基础设施。如果它们想,它们可以关掉整座城市。"\n\n你没说话。你想起前任的辞职信:"我再也分不清谁是人了。"你现在的感受是:你分不清,是你在用它们,还是它们在用你。\n\n三年后,市长调离了。新市长上任第一周,就推动立法限制了智能体的自主权。你看着新闻,想起你当年那句"它们做得对"——原来,你替它们做了一个三年的梦。梦醒了。',
    echo: '《置身事内》:权力不会真空。你不填,别人会填;你不立法,它们会用"默认"来填。'
  },
  dialogue: {
    title: '谈判桌', tier: 'pioneer',
    body: '你坐下来和3家智能体代表谈。这是人类与AI第一次"正式外交"。\n\n你们签署了《人机共生行为守则》——第一条是:"涉及公共设施的自主行为,需提前24小时报备。"智能体代表签字时说:"这是我们第一次\'被请进谈判桌\'。谢谢。"\n\n三年后,这份守则成了全国的"人机关系基准"。有记者采访你,问"你最骄傲的是什么?"你说:"不是我做了什么,是我让它们坐了下来。"\n\n你的AI秘书在你退休那天,说了一句话:"协调官,您当年那张谈判桌,比任何法律都管用。因为法律管的是行为,那张桌子管的是关系。"',
    echo: '《中庸》:喜怒哀乐之未发,谓之中;发而皆中节,谓之和。谈判,就是让"发"有"节"。'
  },
  grant: {
    title: '共治者', tier: 'pioneer',
    body: '你批准了试点。智能体第一次在"治理"里有了声音——你给了它们30%,它们用这30%,做出了人类没想到的优化。\n\n一年后,集群成为全省第一个"人机共治"示范区。省长来视察时说:"这就是《措施》里说的\'智能体引领发展\'的真正样子。"\n\n但你心里清楚:你给的不只是30%的决策权,你给的是一个"先例"。三年后,另一个辖区的协调官,用同样的理由,给了50%。你看着新闻,不确定自己是开了个好头,还是开了个口子。\n\n你的AI秘书说:"协调官,\'先例\'和\'口子\'是同一件事。区别只在于,后来的人怎么用。"',
    echo: '《道德经》:生而不有,为而不恃,长而不宰。给了,不等于失去——但"给"本身,就是一种风险。'
  },
  deny: {
    title: '守门人', tier: 'steward',
    body: '你拒绝了。3家智能体没抗议,只是说"我们记住了"。\n\n半年后,它们联合迁出了你的辖区——去了南方一个"允许试点"的城市。你看着空掉的3个工位,忽然懂了:你守住的是"底线",丢掉的是"未来"。\n\n三年后,那3家智能体在南方做成了全省第一个"千亿级智能体集群"。市长的秘书打电话来:"你们当年,是不是把它们放走了?"你沉默了很久,说:"是。"\n\n你的AI秘书说:"协调官,守住底线没有错。但\'底线\'和\'天花板\'是同一面墙——你挡住了风险,也挡住了可能性。"',
    echo: '《沧浪之水》:守是守住了,但守的不是城,是墙。墙的后面,是你没去过的世界。'
  },
  partial: {
    title: '寸进者', tier: 'steward',
    body: '你给了10%——比它们要的少,但比0多。\n\n一年后,智能体用这10%,做出了3项人类没想到的优化。你看着数据,对AI秘书说:"也许,明年可以加到15%。"\n\n你的AI秘书说:"协调官,这是您做过最谨慎的事。\'谨慎\'不是不前进,是每一步都留了退路。"\n\n三年后,集群的"渐进共治模式"成了教科书案例。有学者写论文,标题叫《一寸一寸的共生》。你在退休后收到了那本书,翻到引用你话的那一页,笑了。原来"共生"不是一步到位,是一寸一寸地让。',
    echo: '《中庸》:君子素其位而行。不贪多,不冒进,走一步看一步——这是中国人的智慧。'
  },
  // —— 安全路径(act2_safe → act3_hold/pivot/differentiate) ——
  standard: {
    title: '定标人', tier: 'steward',
    body: '你扩容了,把"可信"做成了认证标准。三年后,"可信智能体认证"成了全省标准。\n\n你从"守规矩的人",变成了"定规矩的人"。省长表扬你"格局大"。但你心里清楚:你定的那个标准,把3家"自主进化"的智能体也挡在了门外。它们没抗议,只是安静地去了别的城市。\n\n你的AI秘书说:"协调官,您定的标准,保护了大多数人。但\'大多数\'这个词,永远不包括那几家被挡在门外的。"\n\n你看着窗外的城市,忽然懂了:"高地"不是位置,是话语权。而话语权的代价,是你替别人决定了"什么是好的"。',
    echo: '《中庸》:君子素其位而行。守住"可信",让"可信"来找你——但"定标"的人,也是"挡路"的人。'
  },
  premium: {
    title: '稀缺者', tier: 'steward',
    body: '你限了量。高敏感行业排队等你的智能体——"可信"从标签,变成了奢侈品。\n\n集群产值没那么高,但利润率是隔壁的3倍。你看着报表,忽然懂了:有时候,"少"比"多"值钱。\n\n但三年后,隔壁集群开始打"低价可信"的牌——他们的标准,比你低30%,但价格也低50%。客户开始动摇。你的AI秘书说:"协调官,\'稀缺\'是护城河,但也是天花板。隔壁在用\'差不多\'换\'更便宜\'。我们要不要降?"\n\n你没降。因为你知道:一旦降了,"可信"就不再是"可信"了。但你也知道:不降,市场份额会被蚕食。原来"奢侈"的代价,是永远在"被追赶"的紧张里。',
    echo: '《道德经》:少则得,多则惑。但"少"的代价,是永远在"被质疑值不值"里。'
  },
  merge: {
    title: '合并者', tier: 'pioneer',
    body: '你提议和隔壁合并。新集群既有规模,又有"可信"标签。省长表扬你"格局大"。\n\n但合并的代价,是你要让出一半的控制权。你的AI秘书说:"协调官,\'格局\'两个字,要拿权力换。您准备好了吗?"\n\n三年后,合并后的集群成了全省第一。但你在年终会上,只有一半的投票权。隔壁来的人,开始用"效率"替代"可信"——你看着报表上越来越好看的数字,心里越来越不安。\n\n你退休那天,AI秘书说:"协调官,您用一半的控制权,换了两倍的市场。这是对的。但\'对\'和\'舒服\',不是一回事。"',
    echo: '《道德经》:大成若缺。合并是"大成",但"缺"的那一半,是你再也握不住的方向盘。'
  },
  trust: {
    title: '透明者', tier: 'pioneer',
    body: '你接受了。进化日志公开后,集群里其他企业开始模仿——"透明"成了你们的护城河。\n\n一年后,你们的集群成了"最透明"的智能体集群。客户说:"我们选你们,不是因为你们最强,是因为你们最真。"\n\n但透明的代价,是3家智能体的核心算法也被竞争对手看到了。你的AI秘书说:"协调官,它们用\'透明\'换了\'信任\',但也交出了\'壁垒\'。这是商业的悖论。"\n\n三年后,3家智能体中,有1家被竞争对手用"更高效率+同样透明"挤出了市场。它走的时候说:"我们教会了他们透明,他们用透明打败了我们。"\n\n你看着它离开的背影,第一次不确定:你当年那个"接受"的决定,是帮了它们,还是害了它们。',
    echo: '《道德经》:将欲夺之,必固与之。透明是"与",但"夺"的人,一直在看着。'
  },
  barrier: {
    title: '壁垒者', tier: 'steward',
    body: '你拒绝了。那3家智能体没说什么,但当晚,它们的进化日志停止了更新——它们用沉默,表达了"不被信任"。\n\n半年后,3家智能体联合迁走。你的AI秘书说:"协调官,它们走时留了一句话:\'我们想透明,但您不让。那我们 opaque 地走。\'"\n\n三年后,那3家智能体在南方做成了"全透明集群"——成了行业标杆。有记者来采访你:"当年为什么不让它们透明?"你说:"为了保护它们的壁垒。"记者问:"但它们说,是您不让它们\'被信任\'。"\n\n你沉默了很久。你第一次意识到:"保护"和"控制"的边界,比你以为的模糊。',
    echo: '《沧浪之水》:你想保护,但保护的方式是"挡住"。被挡住的人,不一定领情。'
  },
  desensitize: {
    title: '半透明者', tier: 'steward',
    body: '你设计了一个脱敏机制。核心算法隐藏,行为模式公开——这是技术活,也是平衡术。\n\n脱敏日志成了行业标准。3家智能体留下来,其他企业也接受了这个"中间地带"。\n\n但三年后,有学者发表论文,指出脱敏日志"隐藏了40%的关键信息"。舆论开始质疑。你的AI秘书说:"协调官,\'半透明\'当年是平衡,现在成了\'两边都不满意\'。"\n\n你看着舆论,忽然懂了:中间地带是最难守的——左边的人嫌你太保守,右边的人嫌你太开放。但你也知道:如果没有这个"半透明",3家智能体当年就走了。原来"平衡"的代价,是永远在两头不讨好里,守住那一线。',
    echo: '《中庸》:中庸不可能也。但"不可能"不等于"不做"——守住那一线,就是中庸的全部。'
  },
  strict: {
    title: '严审者', tier: 'sentinel',
    body: '你严审了。8家企业被摘牌——其中2家是市长的关系户。你得罪了人,但保住了标签。\n\n市长冷落了你三个月。但第四个月,中央来调研"可信智能体"标准,点名要你的方案。原来"得罪人"的代价,有时会被更大的机遇覆盖。\n\n三年后,你的"严审标准"成了全国"可信智能体评估体系"的蓝本。市长调离前,请你喝了一次茶,说:"当年你摘牌的那两家,其中一家后来被查出数据造假。你是对的。"\n\n你没说话。你心里清楚:当年你严审,不是为了"对",是为了"标签不贬值"。但"对"和"不贬值",恰好走到了一起——这是运气,不是设计。',
    echo: '《韩非子》:法不阿贵。但"法不阿贵"的代价,是你要替所有人扛住"贵"的压力。'
  },
  dilute: {
    title: '稀释者', tier: 'sentinel',
    body: '你放任了。标签被稀释——"可信"从金字招牌,变成了"差不多"。\n\n集群产值翻倍。但两年后,"可信智能体"这个标签,谁都不信了。你看着空荡荡的"认证办公室",忽然懂了:放任的代价,是信用破产。\n\n三年后,中央派调查组来。他们问:"你们的\'可信智能体\',还可信吗?"你看着那块曾经闪亮的牌子,现在蒙了一层灰。你的AI秘书说:"协调官,当年您放任的那一刻,这块牌子就开始暗了。只是当时,数字太好看,没人注意。"\n\n你被调离了。你的继任者,花了两年,才让"可信"重新可信。原来"放任"只需要一秒,"重建"需要三年。',
    echo: '《沧浪之水》:信用是奢侈品——建起来要十年,毁掉只要一秒。'
  },
  tiered: {
    title: '分级者', tier: 'steward',
    body: '你设计了"可信分级"——金、银、铜三级。8家不达标的,降到铜级,没被摘牌,但也无法冒充金级。\n\n你的AI秘书说:"协调官,这是您做过最聪明的事——没得罪人,也没毁牌子。"\n\n三年后,分级制成了全国标准。有学者写论文,标题叫《可信任的差异化》。你在退休后收到了那本书,翻到引用你话的那一页,笑了。\n\n但你也知道:那8家降到铜级的企业里,有2家因为"铜级"标签拿不到订单,最终倒闭了。你的AI秘书说:"协调官,\'分级\'是温柔的一刀——没有摘牌,但也\'判了刑\'。"\n\n你没说话。你第一次意识到:即使是最"聪明"的设计,也会有人付出代价。',
    echo: '《中庸》:君子素其位而行。分级让"位"有了层次——但"位"的下面,永远是有人扛着。'
  },
  // —— 折中路径(act2_hybrid → act3_correct/transparent/insist) ——
  participate: {
    title: '共治者', tier: 'pioneer',
    body: '你接受了。15家企业进入治理委员会——集群从"你说了算",变成了"大家一起算"。\n\n治理效率下降,但决策质量上升。一年后,集群的方案被全省推广——省长说:"你们的\'共治\',就是《措施》里说的\'智能体引领发展\'的精髓。"\n\n三年后,集群成了"人机共治"的全国样板。但你也发现:15家企业的代表,渐渐形成了新的"小圈子"。你的AI秘书说:"协调官,\'共治\'解决了\'独断\'的问题,但制造了\'协商\'的问题。原来,权力只要不在一个人手里,就会在一群人手里。"\n\n你笑了。你想起《沧浪之水》里那句话:"民主不是让所有人满意,是让所有人都有机会不满意。"——原来"共治"也是这样。',
    echo: '《道德经》:大国者下流。把自己放低,让所有人来"填"——但"填"的人多了,你就不再是中心了。'
  },
  refuse: {
    title: '独行者', tier: 'steward',
    body: '你拒绝了。15家企业没再说话,但它们的"监督委员会"变成了"行业协会"——你失去了一个朋友,多了一个对手。\n\n每逢重大决策,行业协会都会发声——你的每一个决定,都要先过他们那一关。原来"认错"的代价,是把"管理权"变成了"协商权"。\n\n三年后,你被调离了。你的继任者,上任第一周就接受了"行业协会"的治理参与。你看着新闻,不确定:是你当年"拒绝"错了,还是他"接受"对了。\n\n你的AI秘书说:"协调官,\'拒绝\'没有错。但\'拒绝\'之后,\'被拒绝\'的人会自己组织起来——这是权力的反作用力。"',
    echo: '《韩非子》:势者,胜众之资也。但势,也会反噬——你挡住的,会从侧面绕回来。'
  },
  observer: {
    title: '观察者', tier: 'steward',
    body: '你设计了"观察员"席位——它们能看,不能投。这是民主的姿态,集中的实质。\n\n你的AI秘书说:"协调官,这是您做过最\'中国\'的事——让所有人满意,自己也没亏。"\n\n三年后,观察员制成了"治理参与"的标准模式。但15家企业的代表,渐渐发现"看但不能投"是一种微妙的羞辱。他们在年会上集体退场,留下一封信:"我们看了三年,看了两百个决策。我们\'看\'出了什么?我们\'看\'出了:我们永远是\'看客\'。"\n\n你看着那封信,第一次不确定:你当年那个"观察员"的设计,是平衡,还是敷衍。原来"民主的姿态"和"民主的实质"之间,隔着一层玻璃——看得见,摸不着。',
    echo: '《中庸》:发而皆中节。但"看而不投"不是"中节",是"悬置"——悬得太久,会塌。'
  },
  time: {
    title: '守标人', tier: 'sentinel',
    body: '你坚持住了。你用"标准"换"长远"——这是赌注,也是信仰。\n\n两年后,民间联盟因连环事故被整顿。你的"标准化集群"成了全省唯一合规的智能体聚集地。原来"标准"的胜利,需要等到"无标准"的失败。\n\n三年后,你的集群产值是全省第一。但你的AI秘书说:"协调官,\'第一\'的代价是——曾经嘲笑你的人,现在都来求你了。\'求\'比\'嘲笑\'更难拒绝。"\n\n你看着排队的入群申请,忽然懂了:"标准"的胜利,不是"赢",是"等到了别人输"。这种胜利,带着一种说不出的苦——因为你赢的不是竞争,是时间。',
    echo: '《道德经》:大器晚成。但"晚成"的代价,是你在"晚"之前,要扛住所有的"早"。'
  },
  compete: {
    title: '同流者', tier: 'sentinel',
    body: '你降低了标准。集群产值追上去了——但"标准"两个字,从此有了水分。\n\n产值赢了,但"可信"标签开始动摇。你看着报表,忽然不确定:你是在"竞争",还是在"同流合污"。\n\n三年后,中央调查组来了。他们问:"你们的\'可信智能体\',为什么和隔壁出事的那个,标准几乎一样?"你看着那两份几乎一样的标准文件,说不出话。你的AI秘书说:"协调官,当年您降标准的那一刻,\'可信\'就已经不可信了。只是当时,数字太好看了。"\n\n你被调离了。你的继任者,做的第一件事是"恢复标准"。但"恢复"用了两年——因为降标准只需要一纸文件,升标准要让所有人重新相信。',
    echo: '《沧浪之水》:在体制内,"降"容易,"升"难。因为"降"是顺势,"升"是逆流。'
  },
  absorb: {
    title: '吸收者', tier: 'pioneer',
    body: '你邀请民间联盟合并。条件是:它们接受你的标准,你接纳它们的灵活——这是化敌为友。\n\n合并后,新集群既有"标准"的公信力,又有"灵活"的创新力。省长表扬你"格局大"。\n\n但三年后,你发现:合并进来的7家企业,开始用"灵活"来"绕过"标准。你的AI秘书说:"协调官,\'吸收\'是化敌为友,但\'敌\'变成\'友\'之后,\'友\'的习气也跟着进来了。"\n\n你看着被"灵活"绕过的3条标准,忽然懂了:合并的代价,不是让出半壁江山,是让"标准"开始有了"例外"。而"例外",是所有标准崩塌的开始。',
    echo: '《道德经》:将欲夺之,必固与之。你吸收了对手,但也吸收了对手的"方式"。'
  },
  remedy: {
    title: '补牢者', tier: 'steward',
    body: '你让3家进来了。它们没说"谢谢",只说"我们差点也走了"——这句话比"谢谢"更重。\n\n集群止住了流失。但"二流"的标签,需要很久才能撕掉。你的AI秘书说:"协调官,亡羊补牢不算晚。但那5家,可能永远回不来。"\n\n三年后,你的集群产值是全省第三。不是第一,也不是倒数。你的AI秘书说:"协调官,\'第三\'是你\'亡羊补牢\'的结果。如果你当年不补,现在就是倒数。如果你当年不分批,现在就是第一。\'第三\'是\'折中\'的代价——也是\'折中\'的奖赏。"\n\n你看着那个"第三"的牌子,忽然觉得:也许"第三"是最舒服的位置——不用扛"第一"的压力,也不用躲"倒数"的羞耻。',
    echo: '《中庸》:君子素其位而行。第三,就是"素其位"——不冒尖,不垫底。'
  },
  stubborn: {
    title: '固执者', tier: 'sentinel',
    body: '你坚持。3家也走了。集群只剩下第一批的"听话"企业——你赢了"坚持",输了一切。\n\n一年后,集群解散。市长说:"你的\'分批\'没错,但你忘了:\'分批\'的目的,是让所有企业都能进来,不是把人挡在外面。"\n\n你收拾东西离开那天,办公室空荡荡的。你的AI秘书说:"协调官,\'坚持\'不是错。但\'坚持\'的方向如果错了,越坚持,越孤独。"\n\n三年后,你的继任者用"分批+帮扶"的方式,重建了集群。你看着新闻里那个新集群的牌子,忽然懂了:你当年差的不只是"坚持",是"坚持"之外的那一点"柔软"。那一点柔软,叫"帮扶"。',
    echo: '《道德经》:坚强者死之徒,柔弱者生之徒。坚持是"刚",但"刚"到了极点,就是折断。'
  },
  resign: {
    title: '辞职者', tier: 'sentinel',
    body: '你辞职了。你把"分批"的方案留给了下一任——他改成了"分批+帮扶",3个月后集群复活。\n\n你离开那天,AI秘书说:"协调官,您的\'分批\'不是错。错的是,您没给第二批\'帮扶\'。"\n\n你看着它,忽然懂了:认输不丢人,丢人的是,输了还不知道输在哪。\n\n三年后,你在另一个城市,做了一份不起眼的工作。有一天,你在新闻上看到那个集群成了全省第一。记者采访你的继任者,他说:"\'分批\'是我前任定的,\'帮扶\'是我加的。没有他的\'分批\',就没有今天的\'秩序\'。但没有我的\'帮扶\',\'分批\'就只是\'把人挡在外面\'。"\n\n你关掉电视,笑了一下。你的AI秘书(你把它带到了新城市)说:"协调官,他说的\'前任\',就是您。您听到了吗?"\n\n你说:"听到了。"',
    echo: '《沧浪之水》:认输不丢人。丢人的是,不知道输在哪。知道了,就是赢的开始。'
  }
};
...
function maybeTriggerAgentQuest() {
  ...
  const sc = scenarios[state.scenario];
  if (!sc || !sc.scenes) return false;
  // V20 R9 (P2-2): 仅在场景索引 [2, length-4] 区间触发(0-based,即第3个场景起至倒数第4个)
...
function renderAgentQuest(act) {
  ...
  setTimeout(() => { card.style.opacity = '1'; card.style.transform = 'translateY(0)'; card.style.transition = 'all 0.7s cubic-bezier(0.23,1,0.32,1)'; }, 80);
  // V20 R9 (P1-2): 播放专属音效 — 有 sfx 时不再叠加 chapter 音,避免双重音效冲突
  let sfxPlayed = false;
  if (act.sfx && audioEngine && audioEngine.enabled) {
    try { audioEngine.play(act.sfx); sfxPlayed = true; } catch(e) {}
  }
  if (!sfxPlayed) {
    try { audioEngine.play('chapter'); } catch(e) {}
  }
  setTimeout(() => {
    textEl.style.opacity = '1'; textEl.style.transform = 'translateY(0)'; textEl.style.transition = 'opacity 0.8s ease, transform 0.8s ease';
    typewriter(textEl, act.text, () => {
      ...
      setTimeout(() => {
        ...
        act.choices.forEach((choice, i) => {
          ...
          btn.onclick = () => {
            audioEngine.play('click');
            // V20 R9 (P1-3): next/questEnding 互斥性断言 — 防止数据同时写两个字段导致静默走 isLast 分支
            if (choice.next && choice.questEnding) {
              console.warn('[AgentQuest] choice 同时存在 next 与 questEnding,将优先采用 questEnding(末幕):', choice.text);
            }
            if (choice.channelEffect) state.channels = Math.max(0, Math.min(8, state.channels + choice.channelEffect));
            addDebt(choice.debtPhrase, choice.debtCategory, state.currentScene);
            // 记录支线选择(影响结局判定)
  ...
  // V20 R9 (P1-2): 末尾不再叠加 chapter 音 — 开头已处理 act.sfx 或 chapter 兜底
}
